...
##
## DESCRIPTION
##    COS 316 test script for assignment 1.
##    Runs 5 different tests between student and reference solution
...
IGC=$A1/reference/client # Reference go client
IGS=$A1/reference/server # Reference go server
SGC=$A1/client  # Student go client
SGS=$A1/server  # Student go server
...
printf "================================================================\n"
printf "Testing student client against reference server (1/3)           \n"
printf "================================================================\n"

if [[ -f "$SGC" ]] && [[ -f "$IGS" ]]; then
  all-tests "$SGC" "$IGS" "$PORT"
else
  printf "\n$SKIP_MESSAGE"
...
printf "================================================================\n"
printf "Testing reference client against student server (2/3)           \n"
printf "================================================================\n"

if [[ -f "$IGC" ]] && [[ -f "$SGS" ]]; then
  all-tests "$IGC" "$SGS" "$PORT"
else
  printf "\n$SKIP_MESSAGE"
  ((testNum+=$TESTS_PER_IMPL))
fi
...
printf "================================================================\n"
printf "Testing student client against student server (3/3)             \n"
printf "================================================================\n"
